/**
 * @file NavMap.cpp
 * @brief Source file for class NavMap
...
// Initialize a map
NavMap::NavMap(float xlen, float ylen, float zlen, size_t nx, size_t ny,
...
std::list<size_t> NavMap::slam_update(std::list<Point> slam_pntcloud) {
...
size_t NavMap::pnt_to_ind(const Point &pnt) {
  // Point idxs
